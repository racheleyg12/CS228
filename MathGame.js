...
function DrawLowerRightPanel(){
	if (answerToProblem == 0){
		image(imgAns0, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 1){
		image(imgAns1, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if(answerToProblem == 2){	
		image(imgAns2, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 3){
		image(imgAns3, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 4){
		image(imgAns4, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 5){
		image(imgAns5, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 6){
		image(imgAns6, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 7){
		image(imgAns7, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 8){
		image(imgAns8, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} else if (answerToProblem == 9){
		image(imgAns9, window.innerWidth/2, window.innerHeight/2, window.innerWidth/2, window.innerHeight/2);
	} 
}
...
function GotResults(err, result){
    ...
    numPrediction += 1;
    meanPredictionAccuracy = (((numPrediction-1)*meanPredictionAccuracy) + (currentPrediction == answerToProblem))/numPrediction;
    //Accuracy
